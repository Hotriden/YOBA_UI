    ...
    <Grid container spacing={1}>
      <Grid item sx={12}>
        <div className='buttonsPanel'>
          ...
          >
            <MenuItem onClick={handleCloseReport}>New Branch</MenuItem>
            <MenuItem onClick={handleCloseReport}>Employee transfer</MenuItem>
          </Menu>
          <Button
              variant="outlined"
              color="inherit"
          ...
          >
            ...
            <MenuItem onClick={handleCloseReport}>Employee transfers</MenuItem>
          </Menu>
        </div>
      </Grid>
      <Grid item xs={12}>
...
export default compose(connect(state => ({Store: state})), withStyles(styles, { withTheme: true }))(Branches);