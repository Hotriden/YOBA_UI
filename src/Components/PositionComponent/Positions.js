    ...
    <Grid container spacing={1}>
      <Grid item sx={12}>
        <div className='buttonsPanel'>
          ...
          >
            <MenuItem onClick={handleCloseReport}>New Position</MenuItem>
            <MenuItem onClick={handleCloseOperation}>New Employee</MenuItem>
            <MenuItem onClick={handleCloseOperation}>New Branch</MenuItem>
          </Menu>
          <Button
              variant="outlined"
              color="inherit"
          ...
          >
            <MenuItem onClick={handleCloseReport}>Positions</MenuItem>
            <MenuItem onClick={handleCloseReport}>Employee</MenuItem>
            <MenuItem onClick={handleCloseReport}>Branches</MenuItem>
          </Menu>
        </div>
      </Grid>
      <Grid item xs={12}>
...
export default compose(connect(state => ({Store: state})), withStyles(styles, { withTheme: true }))(Positions);