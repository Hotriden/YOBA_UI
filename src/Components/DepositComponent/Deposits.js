    ...
    <Grid container spacing={1}>
      <Grid item sx={12}>
        <div className='buttonsPanel'>
          ...
          >
            <MenuItem onClick={handleCloseReport}>New deposite</MenuItem>
          </Menu>
          <Button
              variant="outlined"
              color="inherit"
          ...
          >
            <MenuItem onClick={handleCloseReport}>Deposits</MenuItem>
          </Menu>
        </div>
      </Grid>
      <Grid item xs={12}>
...
export default compose(connect(state => ({Store: state})), withStyles(styles, { withTheme: true }))(Deposits);