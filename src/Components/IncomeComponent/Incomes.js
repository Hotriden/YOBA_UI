    ...
    <Grid container spacing={1}>
      <Grid item sx={12}>
        <div className='buttonsPanel'>
          ...
          >
            <MenuItem onClick={handleCloseReport}>New Income</MenuItem>
            <MenuItem onClick={handleCloseOperation}>Curency operation</MenuItem>
            <MenuItem onClick={handleCloseOperation}>Transfer</MenuItem>
          </Menu>
          <Button
              variant="outlined"
              color="inherit"
          ...
          >
            <MenuItem onClick={handleCloseReport}>Incomes</MenuItem>
            <MenuItem onClick={handleCloseReport}>Cash flow</MenuItem>
...
export default compose(connect(state => ({Store: state})), withStyles(styles, { withTheme: true }))(Incomes);